...
ExtDefList : ExtDef ExtDefList {$$=newNode("ExtDefList",2,$1,$2);}
	| {$$=newNode("ExtDef",0,-1);}
	;
ExtDef : Specifier ExtDecList FH {$$=newNode("ExtDef",3,$1,$2,$3);}
...
Specifier : TYPE {$$=newNode("Specifier",1,$1);}
	...
	;
StructSpecifier : STRUCT OptTag LD DefList RD {$$=newNode("StructSpecifier",5,$1,$2,$3,$4,$5);}
...
VarDec : identifier {$$=newNode("VarDec",1,$1);}
	...
	;
FunDec : identifier LB VarList RB {$$=newNode("FunDec",4,$1,$1,$2,$3,$4);}
...
DefList : Def DefList {$$=newNode("DefList",2,$1,$2);}
	| {$$=newNode("DefList",0,-1);}
	;
Def : Specifier DecList FH {$$=newNode("Def",3,$1,$2,$3);}
	;
...
Dec : VarDec {$$=newNode("Dec",1,$1);}
	...
	;
Exp : Exp AS Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp AND Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp OR Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp RELOP Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp AD Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp SU Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp MU Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp DI Exp {$$=newNode("Exp",3,$1,$2,$3);}
	|LB Exp RB {$$=newNode("Exp",3,$1,$2,$3);}
	|SU Exp {$$=newNode("Exp",2,$1,$2);}
	|NT Exp {$$=newNode("Exp",2,$1,$2);}
	|identifier LB Args RB {$$=newNode("Exp",4,$1,$2,$3,$4);}
	|identifier LB RB {$$=newNode("Exp",3,$1,$2,$3);}
	|Exp LF Exp RF {$$=newNode("Exp",4,$1,$2,$3,$4);}
	|Exp DOT identifier {$$=newNode("Exp",3,$1,$2,$3);}
	|identifier {$$=newNode("Exp",1,$1);}
	|intnumber {$$=newNode("Exp",1,$1);}
	|floatnumber {$$=newNode("Exp",1,$1);}
	|error RB {yyerrok;cher =1;}
	|error AD Exp {yyerrok;cher =1;}
	|error SU Exp {yyerrok;cher =1;}
	|error MU Exp {yyerrok;cher =1;}
	|error DI Exp {yyerrok;cher =1;}
	; 
